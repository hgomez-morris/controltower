...
class AsanaReadOnlyClient:
    def __init__(self, access_token: str) -> None:
        ...
        self.project_statuses_api = asana.ProjectStatusesApi(self.api_client)
    ...
    def get_project(self, project_gid: str) -> Dict[str, Any]:
        opts = {"opt_fields": "name,owner,owner.name,owner.gid,due_date"}
    ...
    def get_project_statuses(self, project_gid: str) -> List[Dict[str, Any]]:
        opts = {"limit": 100}
        statuses = self.project_statuses_api.get_project_statuses_for_project(project_gid, opts=opts)
